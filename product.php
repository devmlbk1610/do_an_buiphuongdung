				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="p-price">
                                <span style="font-size:14px;">Giá</span><br>
                                <span>
                                    <?php if($p_old_price!=''): ?>
							...
							<div class="btn-cart btn-cart1">
                                <input type="submit" value="Thêm giỏ hàng" name="form_add_to_cart">
							</div>
                            </form>
							<!-- <div class="share">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="#feature" aria-controls="feature" role="tab" data-toggle="tab">Đặc trưng</a></li>
							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane" id="review" style="margin-top: -30px;">
                                    ...
                                    <div class="review-form">
                                        ...
                                        $total = $statement->rowCount();
                                        ?>
                                        <h2>Số lượt đánh giá (<?php echo $total; ?>)</h2>
                                        <?php
                                        if($total) {
                                            $j=0;
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        ...
                                        <?php if(isset($_SESSION['customer'])): ?>
                                            ...
                                            <div class="form-group">
                                                <textarea name="comment" class="form-control" cols="30" rows="10" placeholder="Viết đánh giá của bạn tại đây" style="height:100px;"></textarea>
                                            </div>
                                            <input type="submit" class="btn btn-default" name="form_review" value="Gửi">
                                            </form>
                                            <?php else: ?>
                                                <span style="color:red;">Bạn đã đánh giá sản phẩm này</span>
                                            <?php endif; ?>


                                        <?php else: ?>
                                            <p class="error">
												Bạn phải đăng nhập để có thể đánh giá sản phẩm <br>
												<a href="login.php" style="color:red;text-decoration: underline;">Đăng nhập ngay</a>
											</p>
                                        <?php endif; ?>                         
                                    </div>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>">Thêm giỏ hàng</a></p>
                            </div>
                        </div>
                        <?php
                    }
