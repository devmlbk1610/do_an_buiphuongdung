                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Chọn tỉnh/thành phố <span>*</span></label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Phí ship <span>*</span></label>
                            <div class="col-sm-4">
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Danh sách phí ship các tỉnh/thành phố</h1>
	</div>
</section>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    ...
	                    <td>
	                        ...
	                        <a href="#" class="btn btn-danger btn-xs" data-href="shipping-cost-delete.php?id=<?php echo $row['shipping_cost_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Xoá</a>
	                    </td>
	                </tr>
            		<?php
            	}
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">Nếu tỉnh/thành phố chưa được thêm sẽ tính giá khác!</h4>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label"></label>
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-success pull-left" name="form2">Sửa</button>
                            </div>
                        </div>
                    </div>
                </div>
