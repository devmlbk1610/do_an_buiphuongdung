	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">FPT Hà Đông</span>
			</a>
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								<li class="user-footer">
									<div>
										<a href="profile-edit.php" class="btn btn-default btn-flat">Thông tin cá nhân</a>
									</div>
									<div>
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'size.php') || ($cur_page == 'size-add.php') || ($cur_page == 'size-edit.php') || ($cur_page == 'color.php') || ($cur_page == 'color-add.php') || ($cur_page == 'color-edit.php') || ($cur_page == 'country.php') || ($cur_page == 'country-add.php') || ($cur_page == 'country-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php') ) {echo 'active';} ?>">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="size.php"><i class="fa fa-circle-o"></i> Loại sản phẩm</a></li>
                            <li><a href="color.php"><i class="fa fa-circle-o"></i> Màu</a></li>
                            <li><a href="country.php"><i class="fa fa-circle-o"></i> Tỉnh</a></li>
                            <li><a href="shipping-cost.php"><i class="fa fa-circle-o"></i> Phí ship</a></li>
                            <li><a href="top-category.php"><i class="fa fa-circle-o"></i> Danh mục chính</a></li>
                            <li><a href="mid-category.php"><i class="fa fa-circle-o"></i> Danh mục phụ 1</a></li>
                            <li><a href="end-category.php"><i class="fa fa-circle-o"></i> Danh mục phụ 2</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                     ...
                     <li class="treeview <?php if( ($cur_page == 'slider.php') ) {echo 'active';} ?>">
			          <a href="slider.php">
			            <i class="fa fa-picture-o"></i> <span>Slide chính</span>
			          </a>
			        </li>
                    <!-- Icons to be displayed on Shop -->
			        <li class="treeview <?php if( ($cur_page == 'service.php') ) {echo 'active';} ?>">
			          <a href="service.php">
			            <i class="fa fa-list-ol"></i> <span>Dịch vụ cửa hàng</span>
			          </a>
			        </li>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'page.php') ) {echo 'active';} ?>">
			          <a href="page.php">
			            <i class="fa fa-tasks"></i> <span>Cài đặt thông tin cửa hàng</span>
			          </a>
			        </li>
			        ...
			        <li class="treeview <?php  if( ($cur_page == 'baocaodoanhthu.php')||($cur_page == 'baocaodoanhthu.php') ) {echo 'active';} ?>">
			          <a href="baocaodoanhthu.php">
			            <i class="fa fa-money"></i> <span>Báo cáo doanh thu</span>
			          </a>
			        </li>

					<li class="treeview <?php if( ($cur_page == 'quanlytaikhoan.php')||($cur_page == 'quanlytaikhoan.php') ) {echo 'active';} ?>">
