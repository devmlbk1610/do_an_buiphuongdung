						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr class="<?php if($row['cust_status']==1) {echo 'bg-g';}else {echo 'bg-r';} ?>">
									...
									<td><?php if($row['cust_status']==1) {echo 'Kích hoạt';} else {echo 'Huỷ';} ?></td>
									<td>
										<a href="customer-change-status.php?id=<?php echo $row['cust_id']; ?>" class="btn btn-success btn-xs">Kích hoạt/Huỷ</a>
									</td>
									<td>
