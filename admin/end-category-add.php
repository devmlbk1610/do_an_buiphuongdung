...
<section class="content-header">
	<div class="content-header-left">
		<h1>Thêm danh mục phụ 2</h1>
	</div>
	<div class="content-header-right">
		<a href="end-category.php" class="btn btn-primary btn-sm">Quay lại</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Tên danh mục phụ 2 <span>*</span></label>
							<div class="col-sm-4">
