				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Danh mục chính <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Danh mục phụ 1 <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Danh mục phụ 2 <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Chọn loại</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Ảnh chính</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Chọn ảnh </label>
							<div class="col-sm-4" style="padding-top:4px;">
								<input type="file" name="p_featured_photo">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Ảnh phụ</label>
							<div class="col-sm-4" style="padding-top:4px;">
			                        ...
			                        <tbody>
			                        	...
			                        	foreach ($result as $row) {
											...
											<tr>
				                                ...
				                                <td style="width:28px;">
				                                	<a onclick="return confirmDelete();" href="product-other-photo-delete.php?id=<?php echo $row['pp_id']; ?>&id1=<?php echo $_REQUEST['id']; ?>" class="btn btn-danger btn-xs">Xoá</a>
				                                </td>
				                            </tr>
			                        		<?php
			                        	}
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Mở đặc điểm?</label>
							<div class="col-sm-8">
