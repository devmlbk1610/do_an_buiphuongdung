					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title" style="font-weight: bold;">Gửi</h4>
										</div>
										<div class="modal-body" style="font-size: 14px">
											<form action="" method="post">
												...
												<table class="table table-bordered">
													...
													<tr>
														<td></td>
														<td><input type="submit" value="Gửi" name="form1"></td>
													</tr>
												</table>
											</form>
										</div>
                        ...
                        <td>
                           ...
                           foreach ($result1 as $row1) {
                                ...
                                echo '<br>(<b>Loại:</b> '.$row1['size'];
                                echo ', <b>Màu:</b> '.$row1['color'].')';
                                echo '<br>(<b>Số lượng:</b> '.$row1['quantity'];
                                echo ', <b>Giá đơn:</b> '.$row1['unit_price'].' đ)';
                                echo '<br><br>';
                           }
                           ?>
                        </td>
                        <td>
                        	...
                        	<?php elseif($row['payment_method'] == 'Bank Deposit'): ?>
                        		<b>Phương thức:</b> <?php echo '<span style="color:red;"><b>'.$row['payment_method'].'</b></span>'; ?><br>
                        		<b>Id:</b> <?php echo $row['payment_id']; ?><br>
								<b>Ngày:</b> <?php echo $row['payment_date']; ?><br>
                        		<b>Thông tin chuyển khoản:</b> <br><?php echo $row['bank_transaction_info']; ?><br>
                                <?php elseif($row['payment_method'] == 'QR Momo'): ?>
                        		<b>Phương thức:</b> <?php echo '<span style="color:red;"><b>'.$row['payment_method'].'</b></span>'; ?><br>
                        		<b>Id:</b> <?php echo $row['payment_id']; ?><br>
								<b>Ngày:</b> <?php echo $row['payment_date']; ?><br>
                        		<b>Thông tin chuyển khoản:</b> <br><?php echo $row['bank_transaction_info']; ?><br>
