					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6" style="padding-top:5px">
								<input type="file" name="photo">(jpg, jpeg, gif và png)
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Nút </label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="position" class="form-control">
									<option value="Trái" <?php if($position == 'Trái') {echo 'selected';} ?>>Trái</option>
									<option value="Giữa" <?php if($position == 'Giữa') {echo 'selected';} ?>>Giữa</option>
									<option value="Phải" <?php if($position == 'Phải') {echo 'selected';} ?>>Phải</option>
								</select>
							</div>
						</div>				
						<div class="form-group">
