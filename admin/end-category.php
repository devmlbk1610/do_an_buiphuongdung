...
<section class="content-header">
	<div class="content-header-left">
		<h1>Danh mục phụ 2</h1>
	</div>
	<div class="content-header-right">
		<a href="end-category-add.php" class="btn btn-primary btn-sm">Thêm</a>
	</div>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Nếu bạn xoá sẽ xoá toàn bộ sản phẩm của danh mục này.</p>
            </div>
