    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
				...
				<div class="clear"></div>
                <h3 class="special">Xác nhận thanh toán</h3>
                <div class="row">
		                	...
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
                                    ...
                                    <!-- <form class="paypal" action="<?php //echo BASE_URL; ?>payment/paypal/payment_process.php" method="post" id="paypal_form" target="_blank">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn btn-primary" value="<?php // LANG_VALUE_46; ?>" name="form1">
                                        </div>
                                    </form> -->



                                    <form action="payment/bank/qrmomo.php" method="post" >
                                        <input type="hidden" name="amount" value="<?php echo $final_total; ?>">
                                        <div class="col-md-12 form-group">
                                            <label for="">Bạn cần điền số điện thoại vừa thanh toán hoàn tất vào đây</span></label><br>
                                        </div>
                                        <div class="col-md-12 form-group">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn btn-primary" value="Xác nhận" name="form3">
                                        </div>
                                    </form>
