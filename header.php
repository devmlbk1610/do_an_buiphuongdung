			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						?>
						<li><i class="fa fa-user"></i> Xin chào, <?php echo $_SESSION['customer']['cust_name']; ?></li>
						<li><a href="dashboard.php"><i class="fa fa-home"></i> Bảng điều khiển</a></li>
						<?php
					} else {
						?>
			...
			<div class="col-md-3 search-area">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<div class="form-group">
						<input type="text" class="form-control search-top" placeholder="Nhập tên hoặc mã sàn phẩm" name="search_text">
					</div>
